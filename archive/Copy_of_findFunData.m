...
subListFile=['/home/data/Projects/workingMemory/data/subList',session,'.csv'];
subList = csvread(subListFile);
...
for i=1:numSub
    ...
    for j=1:numDataSet
        ...
        if exist(subDir,'dir')
            mkdir(['/home/data/Projects/workingMemory/data/',session,'/funRaw',sub])
            saveDir= ['/home/data/Projects/workingMemory/data/',session,'/funRaw',sub,'/'];
            ...
            if numFunFiles == 0
                ...
                ls
                save(['/home/data/Projects/workingMemory/data/',session,'/',sub,'DiffStruct.mat'],'sub')
...
save(['/home/data/Projects/workingMemory/data/',session,'/subBadRuns.mat'], 'subBadRuns' )