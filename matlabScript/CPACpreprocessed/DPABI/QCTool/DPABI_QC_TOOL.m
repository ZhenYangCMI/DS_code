...
% Last Modified by GUIDE v2.5 06-Apr-2014 10:51:05
...
if ~isempty(handles.MeanFD)
    set(handles.ThrdMotionButton, 'Enable', 'Off');
    TSVFile=fullfile(WorkDir, 'QC', 'HeadMotion.tsv');
    fd=fopen(TSVFile);
    ...
    for i=1:numel(RemainSubjSubjList)
    ...
    set(handles.ThrdMotionButton, 'Enable', 'On');
end
