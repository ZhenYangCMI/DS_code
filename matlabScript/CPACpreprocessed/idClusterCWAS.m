...
for i=1:length(clustList)
    ...
    if strcmp(effect, 'ageByFTdemean') || strcmp(effect, 'ageByBTdemean')....
            || strcmp(effect, 'ageByTotTdemean') || strcmp(effect, 'DS_BT_demean') || strcmp(effect, 'DS_FT_demean')...
            || strcmp(effect, 'DS_TotT_demean')
