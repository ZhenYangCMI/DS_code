...
outputDir=['/home2/data/Projects/workingMemory/groupAnalysis/CWAS/46sub/followup/correlDSAndFullBrainFC/'];
...
for j=1:length(groupList)
    ...
    correl=zeros(numSub, numSeed, numRef);
    for m=1:numRef
        ref=num2str(subList(m))
    ...
    save([outputDir, 'standFullBrainFC_', ROImaskGroup, 'Mask_', group, '_subgroup.mat'],  'correl')
end
