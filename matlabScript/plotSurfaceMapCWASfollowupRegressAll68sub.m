...
imgInputDir = ['/home/data/Projects/workingMemory/groupAnalysis/CWAS_compCor/CWAS68sub/fullModelLinearFWHM8.mdmr/followup/CWASregress/easythresh/'];
...
viewtype='MediumView';
    ...
    InputName=[imgInputDir, 'thresh_FT_ROI1_T1_Z_cmb.nii'];
    OutputName = [surfaceMapOutputDir,'thresh_FT_ROI1_T1_Z_cmb', SurfaceMapSuffix];
