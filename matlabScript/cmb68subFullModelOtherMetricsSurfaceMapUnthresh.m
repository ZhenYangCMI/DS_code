...
for j=1:length(covTypeList)
    ...
    for i=1:length(measureList)
        ...
        DataUpDir = ['/home2/data/Projects/workingMemory/groupAnalysis/rawscores/otherMetrics68sub_', covType, '/fullModel/', modelOrder, '/', measure, '/unthreshed/'];
        ...
        imdata1 = imread([DataUpDir, measure, '_Full_T4_Z_SurfaceMap.jpg']);
        %imdata6=imdata6(1:end,120:1200,:); take a part of the image
        imdata2 = imread([DataUpDir, measure, '_Full_T1_Z_SurfaceMap.jpg']);
        
        imdata3 = imread([DataUpDir, measure, '_Full_T2_Z_SurfaceMap.jpg']);
        
        imdata4 = imread([DataUpDir, measure, '_Full_T5_Z_SurfaceMap.jpg']);
        
        imdata5 = imread([DataUpDir, measure, '_Full_T3_Z_SurfaceMap.jpg']);
        ...
        OutJPGName=[OutputUpDir,'sub68FullModel', measure,'_', covType,  'Unthreshded.jpg'];
