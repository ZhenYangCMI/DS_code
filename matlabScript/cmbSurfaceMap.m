...
for j=1:length(covTypeList)
    ...
    for i=1:length(measureList)
        ...
        DataUpDir1 = ['/home2/data/Projects/workingMemory/groupAnalysis/rawscores/otherMetrics68sub_', covType, '/', model, '/', modelOrder, '/FT/', measure, '/unthreshed/'];
        
        OutputUpDir = ['/home/data/Projects/workingMemory/figs/rawscores/otherMetrics68sub_', covType, '/',model, '/', modelOrder, '/'];
        
        DataUpDir2 = ['/home2/data/Projects/workingMemory/groupAnalysis/rawscores/otherMetrics68sub_', covType, '/', model, '/', modelOrder, '/BT/', measure,  '/unthreshed/'];
        
        
        % T1: main effect of age, T2: main effect of DS, T3:  ageByDS
        
        imdata1 = imread([DataUpDir1, measure, '_FT_T3_Z_SurfaceMap.jpg']);
        %imdata6=imdata6(1:end,120:1200,:); take a part of the image
        imdata2 = imread([DataUpDir1, measure, '_FT_T1_Z_SurfaceMap.jpg']);
        
        imdata3 = imread([DataUpDir1, measure, '_FT_T2_Z_SurfaceMap.jpg']);
        
        imdata4 = imread([DataUpDir2, measure, '_BT_T3_Z_SurfaceMap.jpg']);
        
        imdata5 = imread([DataUpDir2, measure, '_BT_T1_Z_SurfaceMap.jpg']);
        imdata6 = imread([DataUpDir2, measure, '_BT_T2_Z_SurfaceMap.jpg']);
        ...
        OutJPGName=[OutputUpDir,'sub68', model, '_', modelOrder, '_',measure, '_', covType, '_unthreshed.jpg'];
