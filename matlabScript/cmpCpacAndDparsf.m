...
for j=1:numMeasure
    ...
    save([figDir, 'cmpCPACandDP_lowPearson_', measure, '.txt'], '-ascii', '-tabs', 'pearsonLow')
    save([figDir, 'cmpCPACandDP_lowKendall_', measure, '.txt'], '-ascii', '-tabs', 'KendallLow')
    save([figDir, 'cmpCPACandDP_Pearson_', measure, '.txt'], '-ascii', '-tabs', 'pearsonReport')
    save([figDir, 'cmpCPACandDP_Kendall_', measure, '.txt'], '-ascii', '-tabs', 'KendallReport')
    ...
    title('Kendall')
    ylabel('Number of Subjects')
    saveas(figure(1), [figDir, 'cmpCPACandDP_', measure, '.png'])
