...
DPARSFPath='/home2/data/Projects/workingMemory/data/DPARSF_analysis/nativeCal/Results/';
...
%         else
            ...
            CPACfile=[CPACPath, subID, '/scan_rest_1_rest/sca_roi/roi_rois_3mm/bandpass_freqs_0.01.0.1/sca_roi_Z_', num2str(seed), '_3mm.nii.gz'];
            DPARSFfile=[DPARSFPath, 'FC/zROI', num2str(seed), 'FCMap_', num2str(sub), '_3mm_RPI.nii'];
...
save([figDir, 'cmpCPACandDP_Kendall_', measure, '_', num2str(seed),'.txt'], '-ascii', '-tabs', 'KendallReport')
    ...
    title('Kendall')
    ylabel('Number of Subjects')
    saveas(figure(1), [figDir, 'cmpCPACandDP_', measure,'_', num2str(seed), '_nativeCal_nativeDis.png'])
