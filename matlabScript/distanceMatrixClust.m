% compute the distance matrix use the cluster as unit
...
for j=1:length(groupList)
    ...
    for i=1:numSub
        ...
        FileName=['/home/data/Projects/workingMemory/groupAnalysis/CWAS/46sub/followup/ROIFC/CWAS', ROImaskGroup, '/', ROImaskGroup, '_', sub, '.nii']
    ...
    saveas(figure(1), [figDir, 'meanDistClust_', ROImaskGroup, 'Mask_', subGroup, 'subGroup_', corrType, '.png'])
end
