...
DPARSFPath='/home2/data/Projects/workingMemory/data/DPARSF_analysis/nativeCal/';
...
for i=1:numSub
    ...
    if strcmp(measure, 'ReHo')
        CPACfile=[CPACPath, subID, '/scan_rest_1_rest/reho/bandpass_freqs_0.01.0.1/raw_reho_map_3mm.nii.gz'];
        DPARSFfile=[DPARSFPath, 'Results/ReHo/ReHoMap_', num2str(sub), '_3mm_RPI.nii'];
    elseif strcmp(measure, 'ALFF')
        CPACfile=[CPACPath, subID, '/scan_rest_1_rest/alff/hp_0.01/lp_0.1/alff_img_3mm.nii.gz'];
        DPARSFfile=[DPARSFPath, 'Results/ALFF/ALFFMap_', num2str(sub), '_3mm_RPI.nii'];
    elseif strcmp(measure, 'fALFF')
        CPACfile=[CPACPath, subID, '/scan_rest_1_rest/alff/hp_0.01/lp_0.1/falff_img_3mm.nii.gz'];
        DPARSFfile=[DPARSFPath, 'Results/fALFF/fALFFMap_', num2str(sub), '_3mm_RPI.nii'];
...
title('Kendall')
ylabel('Number of Subjects')
saveas(figure(1), [figDir, 'cmpCPACandDP_', measure, '_nativeCal_nativeDis.png'])
