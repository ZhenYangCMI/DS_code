...
for i=1:length(measureList)
    ...
    DataUpDir1 = ['/home2/data/Projects/workingMemory/groupAnalysis/CWAS/68sub/CWAS68sub/FTSep', effect, 'FWHM8.mdmr/surfaceMap/'];
    DataUpDir2 = ['/home2/data/Projects/workingMemory/groupAnalysis/CWAS/68sub/CWAS68sub/BTSep', effect, 'FWHM8.mdmr/surfaceMap/'];
    
    mkdir (['/home2/data/Projects/workingMemory/figs/CWAS/68sub/FTBTSep', effect, 'FWHM8/'])
    OutputUpDir = ['/home2/data/Projects/workingMemory/figs/CWAS/68sub/FTBTSep', effect, 'FWHM8/'];
    
    imdata1 = imread([DataUpDir1, measure, '_age2ByFTdemean_SurfaceMap.jpg']);
    imdata2 = imread([DataUpDir1, measure, '_ageByFTdemean_SurfaceMap.jpg']);
    %imdata6=imdata6(1:end,120:1200,:); take a part of the image
    imdata3 = imread([DataUpDir1, measure, '_age2_demean_SurfaceMap.jpg']);
    imdata4 = imread([DataUpDir1, measure, '_age_demean_SurfaceMap.jpg']);
    imdata5 = imread([DataUpDir1, measure, '_DS_FT_demean_SurfaceMap.jpg']);
    
    imdata6 = imread([DataUpDir2, measure, '_age2ByBTdemean_SurfaceMap.jpg']);
    imdata7 = imread([DataUpDir2, measure, '_ageByBTdemean_SurfaceMap.jpg']);
    %imdata6=imdata6(1:end,120:1200,:); take a part of the image
    imdata8 = imread([DataUpDir2, measure, '_age2_demean_SurfaceMap.jpg']);
    imdata9 = imread([DataUpDir2, measure, '_age_demean_SurfaceMap.jpg']);
    imdata10 = imread([DataUpDir2, measure, '_DS_BT_demean_SurfaceMap.jpg']);
