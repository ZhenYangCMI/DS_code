...
## full/path/to/site
analysisdirectory=/data/yangz8/workSpace/nki_lifespan
#analysisdirectory=/home/yangz/workSpace/mnt_zxn
## full/path/to/site/subject_list
#subject_list=${analysisdirectory}/0script/subjects_odd_half.list
...
standard_template=/data/yangz8/workSpace/codeLib/ccs_beta/templates/MNI152_T1_3mm_brain.nii.gz
########################################################################################
...
#subjects=`cat ${subject_list}`## set your desired spatial smoothing FWHM - we use 6 (acquisition voxel size is 3x3x4mm)
FWHM=6
