...
#subject=$1
## analysisdirectory
dir=/home/data/Projects/workingMemory/data/gRAICAR_analysis/Rockland
...
# SKULL STRIP THE ANALTOMIC IMAGES using bet
echo ---------------------------------------
...
cd ${anat_dir} 
bet defaced_MPRAGE.nii.gz ./reg/highres
cd ${cwd}
...
#Register functional to T1, and T1 to functional using flirt. 
