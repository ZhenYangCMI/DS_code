...
#subject=$1
## analysisdirectory
dir=/home/data/Projects/workingMemory/data/gRAICAR_analysis/wave1
...
cd ${anat_dir} 
bet ${anat}.nii ./reg/highres
3dresample -orient rpi -prefix ./reg/highres_rpi.nii.gz -inset ./reg/highres.nii.gz 
cd ${cwd}
...
then
	3dcalc -a ${rest}.nii[${TRstart}..${TRend}] -expr 'a' -prefix ${rest}_dr.nii.gz -datum float
